...
// assets/js/dist/phoenix_live_view.js
...
var ViewHook = class _ViewHook {
  constructor(view, el, callbacks) {
    ...
    __publicField(this, "liveSocket");
    __publicField(this, "__listeners");
    __publicField(this, "__isDisconnected");
    __publicField(this, "__view");
    this.el = el;
...
// assets/js/live_view_portal/portal.js
var LivePortal = class {
  ...
  constructor(root, opts) {
    ...
    opts.useShadowDOM = opts.useShadowDOM !== false;
    ...
    opts = __spreadValues({
      ...
      params: __spreadValues({ _csrf_token: csrfToken }, opts.extraParams),
      domRoot: root
    }, opts);
    this.liveSocket = new LiveSocket2(opts.socketUrl, Socket, opts);
...
function deadMount(url, appName, useShadowDOM = true) {
...
//# sourceMappingURL=live_view_portal.js.map
